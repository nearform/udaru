...
exports.register = function (server, options, next) {
  ...
  server.route({
    ...
    config: {
      validate: {
        payload: _.pick(validation.createUser, ['id', 'name', 'metadata']),
        headers
      },
  ...
  server.route({
    ...
    config: {
      validate: {
        ...
        payload: _.pick(validation.updateUser, ['name', 'metadata']),
        headers
      },
  ...
  server.route({
    ...
    config: {
      ...
      response: { schema: swagger.List(swagger.TeamRef).label('PagedTeams') }
    }
  })
