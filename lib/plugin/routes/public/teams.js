...
exports.register = function (server, options, next) {
  ...
  server.route({
    ...
    config: {
      validate: {
        payload: _.pick(validation.createTeam, ['id', 'name', 'description', 'metadata', 'user']),
        headers
      },
  ...
  server.route({
    ...
    config: {
      validate: {
        ...
        payload: Joi.object(_.pick(validation.updateTeam, ['name', 'description', 'metadata'])).or('name', 'description', 'metadata'),
        headers
      },
