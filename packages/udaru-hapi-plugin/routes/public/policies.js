  ...
  register (server, options) {
    ...
    server.route({
      ...
      async handler (request) {
        ...
        return {page, limit, ...(await request.udaruCore.policies.list({organizationId, limit: limit, page: page}))}
      },
      config: {
    ...
    server.route({
      ...
      async handler (request) {
        ...
        return {page, limit, ...(await request.udaruCore.policies.listShared({limit: limit, page: page}))}
      },
      config: {
